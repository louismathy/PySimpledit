...
class EditorMainWindow(
    ...
    def __init__(self):
        ...
        self.combo_text_align = QtWidgets.QComboBox()
        self.combo_text_align.addItems(["left", "center", "right"])
        self.combo_text_align.setCurrentText("center")
        self.combo_text_valign = QtWidgets.QComboBox()
        self.combo_text_valign.addItems(["top", "center", "bottom"])
        self.combo_text_valign.setCurrentText("center")
        self.combo_text_method = QtWidgets.QComboBox()
        self.combo_text_method.addItems(["caption", "label"])
        self.combo_text_method.setCurrentText("caption")
        self.edit_text_color = QtWidgets.QLineEdit("#FFFFFF")
        self.edit_text_bg = QtWidgets.QLineEdit("transparent")
        self.edit_text_stroke = QtWidgets.QLineEdit("#000000")
        self.spin_text_stroke = QtWidgets.QSpinBox()
        self.spin_text_stroke.setRange(0, 20)
        self.spin_text_stroke.setValue(0)
        lt.addRow("Text:", self.text_edit)
        lt.addRow("Font Size:", self.spin_text_size)
        lt.addRow("Text Color:", self.edit_text_color)
        lt.addRow("Font:", self.combo_text_font)
        lt.addRow("Align:", self.combo_text_align)
        lt.addRow("Vertical Align:", self.combo_text_valign)
        lt.addRow("Method:", self.combo_text_method)
        lt.addRow("Background:", self.edit_text_bg)
        lt.addRow("Stroke Color:", self.edit_text_stroke)
        lt.addRow("Stroke Width:", self.spin_text_stroke)
        ...
        self.combo_text_align.setEnabled(False)
        self.combo_text_valign.setEnabled(False)
        self.combo_text_method.setEnabled(False)
        self.edit_text_color.setEnabled(False)
        self.edit_text_bg.setEnabled(False)
        self.edit_text_stroke.setEnabled(False)
        self.spin_text_stroke.setEnabled(False)
